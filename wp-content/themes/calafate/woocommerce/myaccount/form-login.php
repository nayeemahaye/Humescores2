		...
		<div class="calafate-checkout-content carousel">
			...
			<div class="carousel-cell">
				...
				<div class="wrapper"><div class="wrapper-second">
					...
					<form method="post" class="login woocommerce-checkout one-half lap--two-thirds palm--one-whole ccform">

						<?php do_action( 'woocommerce_login_form_start' ); ?>

						<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
							<label for="username"><?php esc_html_e( 'Username or email address', 'calafate' ); ?> <span class="required">*</span></label>
						...
						<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
							<label for="password"><?php esc_html_e( 'Password', 'calafate' ); ?> <span class="required">*</span></label>
						...
						<p class="form-row">
							...
							<input type="submit" class="woocommerce-Button button" name="login" value="<?php esc_attr_e( 'Login', 'calafate' ); ?>" />
						</p>

						<p class="woocommerce-LostPassword lost_password">
							<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'calafate' ); ?></a>
						</p>
			...
			<div class="carousel-cell">
				...
				<div class="wrapper"><div class="wrapper-second">
					...
					<form method="post" class="register woocommerce-checkout one-half lap--two-thirds palm--one-whole ccform">
						...
						<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
							...
							<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
								<label for="reg_username"><?php esc_html_e( 'Username', 'calafate' ); ?> <span class="required">*</span></label>
						...
						<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
							<label for="reg_email"><?php esc_html_e( 'Email address', 'calafate' ); ?> <span class="required">*</span></label>
						...
						<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
							...
							<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
								<label for="reg_password"><?php esc_html_e( 'Password', 'calafate' ); ?> <span class="required">*</span></label>
						...
						<p class="woocomerce-FormRow form-row">
							...
							<input type="submit" class="woocommerce-Button button" name="register" value="<?php esc_attr_e( 'Register', 'calafate' ); ?>" />
						</p>
