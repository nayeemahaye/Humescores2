...
function humescores_setup() {
	...
	register_nav_menus( array(
                'main' => esc_html__( 'main', 'humescores' ),
//		'primary' => esc_html__( 'Header', 'humescores' ),
                'secondary' => esc_html__( 'Footer', 'humescores' ),
	) );
...
function humescores_fonts_url() {
	...
	$pt_serif = _x( 'on', 'PT Serif font: on or off', 'humescores' );
        $roboto = _x( 'on', 'Roboto font: on or off', 'humescores' );
        $archivo_black = _x( 'on', 'Archivo Black font: on or off', 'humescores' );
...
function humescores_scripts() {
	...
	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
        ...
        wp_enqueue_script( 'humescores-functions', get_template_directory_uri() . '/js/functions.js', array('jquery'), '20181013', true );
...
acf_add_local_field_group(array(
	'key' => 'group_5bcf43b16d952',
	'title' => 'Post',
	'fields' => array(
		array(
			'key' => 'field_5bcf4403572fd',
			'label' => 'Intro Paragraph',
			'name' => 'intro_paragraph',
			'type' => 'text',
			'instructions' => 'Type in your introductory paragraph here. This will be shown beside the title.',
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '50',
			...
			'default_value' => '',
			'placeholder' => 'Type in your introductory paragraph here. This will be shown beside the title.',
			'prepend' => '',
			'append' => '',
			'maxlength' => '',
		),
